...
theme.wallpaper                                 = os.getenv("HOME") .. "/pic/sunrise.jpg"
theme.font                                      = "xos4 Terminus 16"
...
mailicon:buttons(my_table.join(awful.button({ modkey }, 1, function () awful.spawn("thunderbird-bin") end)))
...
theme.volume = lain.widget.alsabar({
    ...
    notification_preset = { font = "xos4 Terminus 18", fg = theme.fg_normal },
})

-- spotify launcher (defaced MPD widget)
local musicplr = awful.util.terminal .. " -title Music -g 130x34-320+16 -e ncmpcpp"
local mpdicon = wibox.widget.imagebox(theme.widget_music)
mpdicon:buttons(my_table.join(
    awful.button({ modkey }, 1, function () awful.spawn("spotify") end)))
...
cpuicon:buttons(my_table.join(
    awful.button({ modkey }, 1, function () awful.spawn("urxvt -e htop") end))
)
...
theme.fs = lain.widget.fs({
    notification_preset = { fg = theme.fg_normal, bg = theme.bg_normal, font = "xos4 Terminus 18" },
    settings = function()
