...
local email        = "thunderbird-bin"
local guieditor    = "atom"
local scrlocker    = "slock"
local calculator   = "galculator"
local scrshot      = "flameshot gui"

awful.util.terminal = terminal
awful.util.tagnames = {"0", "1", "2", "3", "4", "5", "misc" }
...
screen.connect_signal("property::geometry", function(s)
    ...
    if beautiful.wallpaper then
        ...
        --gears.wallpaper.centered(beautiful.wallpaper, s, "black", 10)
...
globalkeys = my_table.join(
    -- Take a screenshot
    awful.key({ altkey }, "p", function() os.execute(scrshot) end,
